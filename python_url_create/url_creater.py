...
def baidu():
    csvfile = pd.read_csv('words_A.csv', encoding='gbk')
    ...
    for i, word in enumerate(words):
        txtfile = open('.\\URL_BAIDU_CSV_A\\url_baidu_' + word + '.csv', 'a+', encoding='utf-8')
        one = 86400
...
def google():
    ...
    for i, word in enumerate(words):
        urlfile = open('.\\URL_GOOGLE_CSV_A' + '\\url_google_' + word + '.csv', 'a+', encoding='utf-8')
        one = 86400
